...
--
-- Host: localhost    Database: okidocs
-- ------------------------------------------------------
...
--
-- Table structure for table `excuse_slips`
--
...
CREATE TABLE `excuse_slips` (
  ...
  PRIMARY KEY (`slip_id`),
  KEY `student_id` (`student_id`),
  CONSTRAINT `excuse_slips_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `students` (
  ...
  `acc_password` varchar(8) NOT NULL,
...
-- Dump completed on 2025-12-19  8:30:43
